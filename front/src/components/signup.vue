...
<template>
    ...
    <div class="englobeForm">    
        <form>
            ...
            <button type="submit" class="btn btn-primary" id="inscrireButton" @click.prevent="signUser(email, password)">S'inscrire</button>
        </form>
    </div>
</template>
...
@media screen and (max-width: 416px) and (min-width: 375px) {
    .connexion {
